...
from RML2016a_filter_classes_str_dic import convert_labels_to_dict, tensor_to_labels
from getdataset_RML2016a import ModulationRecognitionDataset_RML2016a
import random
...
if dataset_type =='RML2016a':
    ...
    train_dataset = ModulationRecognitionDataset_RML2016a(train_name, select_every, snr_list, RML2016a_list)
    valid_dataset = ModulationRecognitionDataset_RML2016a(test_name, select_every, snr_list, RML2016a_list)
# if dataset_type == 'RML2016a':
#     print('RML2016a改版')
...
plt.savefig('{}+{}'.format(network_name, dataset_type), dpi=300, bbox_inches='tight')
plt.close()
# 计算总混淆矩阵
