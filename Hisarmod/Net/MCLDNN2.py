...
class MCLDNN2(nn.Module):
    def __init__(self, num_classes=26):
        super(MCLDNN2, self).__init__()
        
        self.dr = 0.5  # dropout rate (%)

        self.conv1_1 = nn.Conv1d(2, 50, 8, padding=3)
        self.conv1_2 = nn.Conv1d(1, 50, 8, padding=3)
        self.conv1_3 = nn.Conv1d(1, 50, 8, padding=3)
        self.conv2 = nn.Conv1d(100, 50,  8, padding=3)
        self.conv4 = nn.Conv1d(100, 100,  5, padding=0)
        self.relu1 = nn.ReLU()
...
# # Example usage:
# input1 = torch.rand(4, 2, 1024)  # Example input with batch size 1
